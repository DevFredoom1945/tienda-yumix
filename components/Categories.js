...
const CATEGORIES = [
  ...
  {
    title: 'Ropa',
    // Nueva imagen que sí carga
    img: 'https://images.unsplash.com/photo-1520974735194-45b0f2ad4053?q=80&w=600',
  },
  {
    title: 'Computadores',
  ...
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1501045661006-fcebe0257c3f?q=80&w=600',
  },
  {
          ...
          >
            <div className="cat-imgwrap">
              <img
                ...
                alt={c.title}
                onError={(e) => {
                  // pequeño fallback si una imagen falla
                  e.currentTarget.src =

    ...
    <section className="auth-wrap">
      <div className="auth-card">
        ...
        <div className="auth-tabs">
          ...
          <button className={`tab ${mode==='register' ? 'active' : ''}`} onClick={() => setMode('register')}>Registrarme</button>
        </div>

        <button className="btn btn-google" onClick={signInWithGoogle} disabled={oauthLoading} aria-busy={oauthLoading}>
        ...
        <div className="auth-links">
          {mode === 'login'
            ? <a href="/registro" onClick={(e)=>{e.preventDefault(); setMode('register');}}>¿No tienes cuenta? Regístrate</a>
            : <a href="/login" onClick={(e)=>{e.preventDefault(); setMode('login');}}>¿Ya tienes cuenta? Inicia sesión</a>
          }
